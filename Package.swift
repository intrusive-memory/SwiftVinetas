...
let package = Package(
  ...
  dependencies: [
    ...
    .package(
      url: "https://github.com/intrusive-memory/flux-2-swift-mlx.git", .upToNextMajor(from: "3.3.0")
    ),
    ...
    .package(
      url: "https://github.com/intrusive-memory/pixart-swift-mlx.git", .upToNextMajor(from: "0.7.4")
    ),
